/* Kata Workbench — Layout C seed data: saved katas (named run-specs) and
   run history. Run records carry the run.completed summary fields. */
(function () {
  const savedKatas = [
  ...
  // Event streams keyed by run id (abbreviated, normalized KataEvents).
  const streams = {
    "r-2041": [
  ...
  window.WBLibrary = { savedKatas, history, streams };
})();
